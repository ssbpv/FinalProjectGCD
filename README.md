...
**TidyMeanStd.txt:** 
Tidy data set with the average of each variable of mean and standard deviation for each activity and each subject. Please use the following code to read it if reading from github:
